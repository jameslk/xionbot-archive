...
CLEAN :
	...
	-@erase "$(INTDIR)\php_event.obj"
	-@erase "$(INTDIR)\php_funcs.obj"
	-@erase "$(INTDIR)\php_log.obj"
	-@erase "$(INTDIR)\php_main.obj"
...
LINK32_OBJS= \
	"$(INTDIR)\php_event.obj" \
	"$(INTDIR)\php_funcs.obj" \
	"$(INTDIR)\php_log.obj" \
	"$(INTDIR)\php_main.obj" \
	"$(INTDIR)\conf.obj" \
	"$(INTDIR)\event.obj" \
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "php5" /I "php5\main" /I "php5\Zend" /I "php5\TSRM" /I "php5\sapi\embed" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "NDEBUG" /D "_LIB" /D "ZTS" /D "ZEND_WIN32" /D "PHP_WIN32" /D ZEND_DEBUG=0 /Fp"$(INTDIR)\xionbot.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\xionbot.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=php5embed.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib WS2_32.LIB WSOCK32.LIB /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\xionbot.pdb" /debug /machine:I386 /nodefaultlib:"MSVCRT" /out:"$(OUTDIR)\xionbot.exe" /pdbtype:sept /libpath:"php5\libs" 
LINK32_OBJS= \
	"$(INTDIR)\php_event.obj" \
	"$(INTDIR)\php_funcs.obj" \
	"$(INTDIR)\php_log.obj" \
...
"$(INTDIR)\php_event.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\php_funcs.c

"$(INTDIR)\php_funcs.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\php_log.c

"$(INTDIR)\php_log.obj" : $(SOURCE) "$(INTDIR)"


SOURCE=.\php_main.c

"$(INTDIR)\php_main.obj" : $(SOURCE) "$(INTDIR)"
